...
- **Brand Repository:** https://github.com/liorahealth-commits/liora-site

### 🎓 Harvard CS50 Problem Sets
*Harvard University's Introduction to Computer Science*
- **Description:** Completed coursework including algorithms, data structures, web development, and software engineering principles
- **Technologies:** C, Python, SQL, Flask, HTML, CSS, JavaScript
- **Skills:** Problem-solving, algorithm design, full-stack development
- **Note:** Repository private per academic policy.
